...
export async function POST(request: NextRequest) {
  try {
    ...
    if (referringClinicId) referralData.referring_clinic_id = referringClinicId
    if (referredToClinicId) referralData.referred_to_clinic_id = referredToClinicId
    if (referredToType) referralData.referred_to_type = referredToType
    if (originatingAppointmentId) referralData.originating_appointment_id = originatingAppointmentId
