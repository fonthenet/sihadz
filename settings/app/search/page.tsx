  ...
  useEffect(() => {
    const fetchDoctors = async () => {
      ...
      if (doctorsData && doctorsData.length > 0) {
        ...
        const profilesMap = new Map((profiles || []).map(p => [p.id, p as { id: string; full_name?: string; avatar_url?: string }]))
              ...
              <CardContent className="p-0">
                <div className="grid md:grid-cols-[200px_1fr_auto] gap-6 p-6">
                  ...
                  <div className="flex justify-center md:justify-start">
                    <Avatar className="h-40 w-40 rounded-full ring-2 ring-primary/20">
                      <AvatarImage src={doctor.avatarUrl || undefined} alt="" className="object-cover" />
                      <AvatarFallback className="rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 text-primary">
