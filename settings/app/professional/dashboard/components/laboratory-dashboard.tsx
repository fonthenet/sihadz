...
import { 
  FlaskConical, Bell, Settings, LogOut, Clock, CheckCircle, 
...
export default function LaboratoryDashboard({ professional, profile, onSignOut }: DashboardProps) {
  ...
  const loadDashboardData = async () => {
    ...
    // Load lab requests sent to this laboratory
                        ...
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            <div className="flex items-center gap-2">
                              <p className="font-medium">{req.patient?.first_name} {req.patient?.last_name}</p>
                              {req.priority === 'stat' && (
                            ...
                            <p className="text-sm text-muted-foreground">
                              From: Dr. {req.doctor?.profiles?.first_name} {req.doctor?.profiles?.last_name}
                            </p>
