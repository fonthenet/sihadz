  ...
  return (
    <footer className="border-t bg-muted/30">
      ...
      <div className="border-b bg-primary/5">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div>
              <h3 className="text-lg font-semibold text-foreground">{l.newsletter}</h3>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5 [dir=rtl]:auto-cols-fr">
          {/* About */}
          <div className="lg:col-span-2">
            ...
            <p className="text-pretty text-sm text-muted-foreground leading-relaxed mb-6">
              {l.aboutDesc}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/register/pharmacy" className="text-muted-foreground hover:text-primary transition-colors">
                  {l.joinAsPharmacy}
                </Link>
              </li>
              <li>
