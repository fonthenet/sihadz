...
import { FlaskConical, Calendar, Clock, Building2, FileText, Download, AlertCircle, CheckCircle } from 'lucide-react'
...
const LAB_STATUS_LABELS: Record<string, { en: string; ar: string; fr: string; color: string }> = {
  ...
  fulfilled: { en: 'Results Ready', ar: 'النتائج جاهزة', fr: 'Résultats prêts', color: 'bg-green-500' },
}
                  ...
                  <CardContent className="space-y-3">
                    ...
                    {request.result_pdf_url && (
                      <Button 
                        ...
                        asChild
                      >
                        <a href={request.result_pdf_url} target="_blank" rel="noopener noreferrer">
