...
export const translations = {
  ar: {
    ...
    searchPlaceholder: 'ابحث عن طبيب، عيادة، صيدلية، مختبر...',
    ...
    // How it works
    howItWorks: 'كيف يعمل؟',
    step1Title: 'ابحث عن مقدم رعاية صحية',
  ...
  fr: {
    ...
    searchPlaceholder: 'Rechercher médecin, clinique, pharmacie, labo...',
    ...
    step1Title: 'Recherchez un professionnel de santé',
