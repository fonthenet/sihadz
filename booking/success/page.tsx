          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between py-3 border-b">
              <span className="text-muted-foreground flex items-center gap-2">
                ...
                {language === 'ar' ? 'الطبيب' : language === 'fr' ? 'Médecin' : 'Doctor'}
              </span>
              <span className="font-medium">{doctorName}</span>
            </div>
            <div className="flex items-center justify-between py-3 border-b">
              <span className="text-muted-foreground flex items-center gap-2">
                {visitType === 'e-visit' ? <Video className="h-4 w-4" /> : <Building className="h-4 w-4" />}
                {language === 'ar' ? 'نوع الزيارة' : language === 'fr' ? 'Type de visite' : 'Visit Type'}
              </span>
              <span className="font-medium">{visitType === 'e-visit' ? t('eVisit') : t('inPerson')}</span>
            </div>
            <div className="flex items-center justify-between py-3 border-b">
              <span className="text-muted-foreground flex items-center gap-2">
