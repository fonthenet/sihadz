...
export default function NotificationsPage() {
  ...
  // Fetch notifications and detect user type for correct back link
  useEffect(() => {
    const fetchNotifications = async () => {
      ...
      // Check if user has a professional profile (for correct Back to Dashboard link)
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        {/* Back Button */}
        <Link href={isProfessional ? '/professional/dashboard' : '/dashboard'}>
